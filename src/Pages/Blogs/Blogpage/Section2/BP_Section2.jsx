    ...
    <>
      ...
      />
        <div className="BP_section2_CategoryContainer">
            ...
            <hr className="BP_hr" />
            <p className="BP_section2_CategoryContainer_text" onClick={()=>filterItem('lor')}>LOR</p>
            <hr />
            <p className="BP_section2_CategoryContainer_text" onClick={()=>filterItem('sop')}>SOP</p>
            <hr />
            <p className="BP_section2_CategoryContainer_text" onClick={()=>filterItem('assignment')}>Assignment</p>
            <hr />
            <p className="BP_section2_CategoryContainer_text" onClick={()=>filterItem('uncategorised')}>Uncategorised</p>
