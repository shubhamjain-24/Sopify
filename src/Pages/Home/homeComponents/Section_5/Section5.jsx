  ...
  return (
    ...
    <div className="s5-headingDiv">
          ...
          <div className="s5-headingDiv2">
            ...
            We strive to provide unique, proper, and valuable drafts to each and every student which makes us different from our Competitors
            </div>
          </div>
        </div>
