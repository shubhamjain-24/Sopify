    ...
    <div className="AU_section5_gridContainer">
        <div className="AU_section5_gridContainerDiv">
            ...
            <div className="AU_section5_gridContainerDiv-textDiv">
                <div className="AU_section5_gridContainerDiv-text1">Aniket Shah</div>
        ...
        <div className="AU_section5_gridContainerDiv">
            ...
            <div className="AU_section5_gridContainerDiv-textDiv">
                <div className="AU_section5_gridContainerDiv-text1">Jitendra Sadhwani</div>
                <div className="AU_section5_gridContainerDiv-text2">CFO & COO</div>
            </div>
        </div>
        <div className="AU_section5_gridContainerDiv">
            <img className='AU_section5_gridContainerDiv-img' src={img3} alt="" />
            <div className="AU_section5_gridContainerDiv-textDiv">
                <div className="AU_section5_gridContainerDiv-text1">Nirvi Shukla</div>
                <div className="AU_section5_gridContainerDiv-text2">Chief Quality Officer</div>
            </div>
        </div>
        <div className="AU_section5_gridContainerDiv">
            <img className='AU_section5_gridContainerDiv-img' src={img4} alt="" />
            <div className="AU_section5_gridContainerDiv-textDiv">
                <div className="AU_section5_gridContainerDiv-text1">Sanika Naik</div>
